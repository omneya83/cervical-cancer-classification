...
lgraph = replaceLayer(lgraph,"ClassificationLayer_predictions",layer2);


%% remove layers and add self attention
lgraph = removeLayers(lgraph, ["new_fc" "prob" "classoutput"]);
layers=[flattenLayer('Name', 'flatten')
    selfAttentionLayer(8,512 , 'Name', 'self_attention');
